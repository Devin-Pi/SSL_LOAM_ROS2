...
public:
    ...
    void addPoseToGraph(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr &pointcloud_edge_in,
...
private:
    ...
    double estimateOdom(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr &pc_source_edge,
